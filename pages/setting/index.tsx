...
import { Tabs } from '../../components/home-components';
...
const dataSource = [
    {
        id: '1',
        time: '2021-10-21',
        detail: '【招聘通知】这是一段招聘通知的消息提示这是一段招聘通知的消息提示这是一段招聘通知的消息提示这是一段招聘通知的消息提示',
        action: '查看',
    },
    {
        id: '2',
        time: '2021-10-21',
        detail: '【学习通知】亲爱的wendy同学，您购买的XXXX课程尚未付款，订单还有3小时就失效了，请尽快支付。和我一起学习吧！',
        action: '查看',
    },
    {
        id: '3',
        time: '2021-10-21',
        detail: '【系统通知】这是一段系统通知的消息提示这是一段系统通知的消息提示这是一段系统通知的消息提示这是一段系统通知的消息提示',
        action: '查看',
    },
    {
        id: '4',
        time: '2021-10-21',
        detail: '【学习通知】这是一段招聘通知的消息提示这是一段招聘通知的消息提示这是一段招聘通知的消息提示这是一段招聘通知的消息提示',
        action: '查看',
    },
];
